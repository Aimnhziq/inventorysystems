        ...
        <div class="col-xl-8">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <form>
                <div class="row mb-3">
                  <label for="adminUsername" class="col-md-4 col-lg-3 col-form-label">Username</label>
                  <div class="col-md-8 col-lg-9">
                    <input name="adminUsername" type="text" class="form-control" id="adminUsername" value="<?php echo $row['adminusername']; ?>" readonly>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="adminEmail" type="email" class="form-control" id="adminEmail" value="<?php echo $row['adminemail']; ?>" readonly>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="adminPhone" type="text" class="form-control" id="adminPhone" value="<?php echo $row['adminphone']; ?>" readonly>
                  </div>
                </div>

              </form><!-- End Admin Profile Info -->
